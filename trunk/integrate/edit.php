...
<table width="260">
    <tr>
        <td style="height: 25px;"><label style="font-size: 12px;" for="gdsr_review"><?php _e("Restriction", "gd-star-rating"); ?>:</label></td>
        <td align="right" style="height: 25px;" valign="baseline">
        <?php GDSRHelper::render_timer_combo("gdsr_timer_type_recc", $timer_restrictions, 110, '', false, 'gdsrTimerChange(\'_recc\')'); ?>
        </td>
    </tr>
</table>
<div id="gdsr_timer_date_recc" style="display: <?php echo $timer_restrictions == "D" ? "block" : "none" ?>">
    <table width="260">
        <tr>
            <td style="height: 25px;"><label style="font-size: 12px;" for="gdsr_review"><?php _e("Date", "gd-star-rating"); ?>:</label></td>
            <td align="right" style="height: 25px;" valign="baseline">
...
<div id="gdsr_timer_countdown_recc" style="display: <?php echo $timer_restrictions == "T" ? "block" : "none" ?>">
    <table width="260">
        <tr>
            <td style="height: 25px;"><label style="font-size: 12px;" for="gdsr_review"><?php _e("Countdown", "gd-star-rating"); ?>:</label></td>
            <td align="right" style="height: 25px;" valign="baseline">
...
<h4 class="gdsr-section-title">
    <a id="gdsr-bullet-thc" href="javascript:gdsrPostEditSection('thc')" class="gdsr-bulleter-basic gdsr-bullet-closed"><?php _e("Comment Stars Rating", "gd-star-rating"); ?></a>
</h4>
