...
$chart->drawPieGraph($data_set->GetData(),$data_set->GetDataDescription(),170,130,130,PIE_PERCENTAGE,TRUE,50,20,5);
...
$chart->drawTitle(20,29,"Chart with votes distribution",250,50,50);
