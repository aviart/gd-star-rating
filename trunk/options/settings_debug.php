...
<tr><th scope="row"><?php _e("Inline Debug Info", "gd-star-rating"); ?></th>
    <td>
        ...
        <strong>Important: </strong><?php _e(sprintf("I strongly recommend leaving this option active. It doesn't disrupt the page, it's hidden and very small."), "gd-star-rating"); ?>
    </td>
</tr>
<tr><th scope="row"><?php _e("Log Into File", "gd-star-rating"); ?></th>
    <td>
        ...
        <div class="gdsr-table-split"></div>
        <strong>Important: </strong><?php _e(sprintf("Plugin must have write access to a text file. Path to this file needs to be set in %s file.", '<em style="color:red">gd-star-config.php</em>'), "gd-star-rating"); ?>
    </td>
</tr>
</tbody></table>
