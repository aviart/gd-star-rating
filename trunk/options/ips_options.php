    ...
    <td>
        ...
        <table cellpadding="0" cellspacing="0" class="previewtable">
            <tr>
                ...
                <td><input style="width: 30px;" maxlength="3" name="gdsr_ip_range_from_1" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_from_2" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_from_3" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_from_4" type="text"></td>
            </tr>
            <tr>
                <td width="150"><strong><?php _e("To", "gd-star-rating"); ?>:</strong></td>
                <td><input style="width: 30px;" maxlength="3" name="gdsr_ip_range_to_1" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_to_2" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_to_3" type="text">.<input style="width: 30px;" maxlength="3" name="gdsr_ip_range_to_4" type="text"></td>
            </tr>
        </table>
        <div class="gdsr-table-split"></div>
        <input type="submit" class="inputbutton" value="<?php _e("Add", "gd-star-rating"); ?>" name="gdsr_preview_scan" id="gdsr_preview_scan" />
...
<tr><th scope="row"><?php _e("Ban IP Masked", "gd-star-rating"); ?></th>
    <td>
        ...
        <table cellpadding="0" cellspacing="0" class="previewtable">
            <tr>
                <td width="150"><strong><?php _e("Maxk", "gd-star-rating"); ?>:</strong></td>
