...
<tr><th scope="row"><?php _e("Custom Elements", "gd-star-rating"); ?></th>
    <td>
        <?php include(STARRATING_PATH."/options/templates_elements_custom.php"); ?>
    </td>
</tr>
<tr><th scope="row"><?php _e("Articles", "gd-star-rating"); ?></th>
    <td>
        <?php include(STARRATING_PATH."/options/templates_elements_articles.php"); ?>
    </td>
</tr>
<tr><th scope="row"><?php _e("Comments", "gd-star-rating"); ?></th>
    <td>
        <?php include(STARRATING_PATH."/options/templates_elements_comments.php"); ?>
    </td>
</tr>
</tbody></table>
</div>
...
<tr><th scope="row"><?php _e("Rating Text", "gd-star-rating"); ?></th>
    <td>
        ...
        <strong>Allowed elements:</strong> %CMM_RATING%, %MAX_CMM_RATING%, %CMM_VOTES%, %WORD_VOTES%
    </td>
</tr>
</tbody></table>
</div>
