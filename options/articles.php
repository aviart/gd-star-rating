...
<?php
    ...
    foreach ($rows as $row) {
        ...
        echo '<td class="gdrinner">';
            ...
            echo '<a title="'.__("Chart", "gd-star-rating").'" onclick="generateUrl('.$row->pid.')" href="#TB_inline?height=520&amp;width=950&amp;inlineId=gdsrchart" class="thickbox"><img alt="'.__("Chart", "gd-star-rating").'" src="'.STARRATING_URL.'gfx/chart.png" border="0" /></a><br />';
