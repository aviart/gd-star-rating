...
<ul>
    ...
    <li><a href="#fragment-4"><span><?php _e("Cleanup", "gd-star-rating"); ?></span></a></li>
    <li><a href="#fragment-5"><span><?php _e("T2 Templates", "gd-star-rating"); ?></span></a></li>
    <li><a href="#fragment-1"><span><?php _e("Graphics", "gd-star-rating"); ?></span></a></li>
    <li><a href="#fragment-6"><span><?php _e("Edit CSS", "gd-star-rating"); ?></span></a></li>
</ul>
...
<div id="fragment-5">
<?php include STARRATING_PATH."options/tools/tools_t2.php"; ?>
</div>
<div id="fragment-6">
