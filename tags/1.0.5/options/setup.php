...
<form method="post" onsubmit="return areYouSure()">
    ...
    <div id="rightnow">
        ...
        <table>
            <tr>
                <td><p class="submit" style="border: 0; margin: 0;"><input type="submit" value="<?php _e("FULL UNINSTALL", "gd-star-rating"); ?>" name="gdsr_full_uninstall" style="width: 150px;" /></p></td>
