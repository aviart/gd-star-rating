<input type="hidden" id="gdstarr-divtemplate[<?php echo $wpnm; ?>]" name="<?php echo $wpfn; ?>[div_template]" value="<?php echo $instance['div_template'] ?>" />
<div id="gdstarr-divtemplate-off[<?php echo $wpnm; ?>]" style="display: <?php echo $instance['div_template'] == '1' ? 'none' : 'block' ?>">
...
<div id="gdstarr-divtemplate-on[<?php echo $wpnm; ?>]" style="display: <?php echo $instance['div_template'] == '1' ? 'block' : 'none' ?>">
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  <tr>
    ...
    <td align="right"><input class="widefat" style="width: 295px" type="text" name="<?php echo $wpfn; ?>[template]" id="gdstarr-tplitem" value="<?php echo wp_specialchars($instance["template"]); ?>" /></td>
  </tr>
</table>
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  <tr>
...
<input type="hidden" id="gdstarr-divelemets[<?php echo $wpnm; ?>]" name="<?php echo $wpfn; ?>[div_elements]" value="<?php echo $instance['div_elements'] ?>" />
<div id="gdstarr-divelemets-off[<?php echo $wpnm; ?>]" style="display: <?php echo $instance['div_elements'] == '1' ? 'none' : 'block' ?>">
<table border="0" cellpadding="2" cellspacing="0" width="100%" style="margin-bottom: 10px">
  <tr>
...
<div id="gdstarr-divelemets-on[<?php echo $wpnm; ?>]" style="display: <?php echo $instance['div_elements'] == '1' ? 'block' : 'none' ?>">
<table border="0" cellpadding="2" cellspacing="0" width="100%" style="margin-bottom: 10px">
  <tr>
    <td width="100" valign="top"><strong><a style="text-decoration: none" href="javascript:gdsrShowHidePreview('gdstarr-divelemets', '<?php echo $wpnm; ?>')"><?php _e("Elements", "gd-star-rating"); ?></a></strong></td>
