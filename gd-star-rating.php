        ...
        */
        ...
        function cached_posts($votes) {
            ...
            foreach ($alls as $vote => $settings) {
                ...
                switch ($cde) {
                    case "asr":
                        $html = $this->render_article_actual($settings);
                        break;
                    case "atr":
        ...
        function render_thumb_comment_actual($settings) {
            ...
            $override["style"] = $this->g->thumbs[$settings[10]]->folder;
            $override["style_ie6"] = $this->g->thumbs[$settings[11]]->folder;
        ...
        function render_thumb_comment($post, $comment, $user, $override = array()) {
            ...
            if ($override["tpl"] == 0) $override["tpl"] = $this->o["default_tcb_template"];
        ...
        function render_comment_actual($settings) {
            if ($this->o["comments_active"] != 1 || $this->is_bot) return GDSRRender::bot_response();
        ...
        function render_thumb_article_actual($settings) {
            ...
            if ($allow_vote) {
                if ($this->o["author_vote"] == 1 && $rd_user_id == $post_author) {
                    $allow_vote = false;
                    $dbg_allow = "A";
                }
            }
            ...
            if ($allow_vote && ($post_data->expiry_type == 'D' || $post_data->expiry_type == 'T' || $post_data->expiry_type == 'I')) {
                ...
                switch($expiry_type) {
                    case "D":
                        ...
                        break;
                    case "T":
                        $remaining = GDSRHelper::expiration_countdown($post_date, $expiry_value);
            ...
            $tags_css = array(
                "CSS_BLOCK" => $this->o["srb_class_block"],
                "CSS_HEADER" => $this->o["srb_class_header"],
                "CSS_STARS" => $this->o["srb_class_stars"],
                "CSS_TEXT" => $this->o["srb_class_text"]
            );
        ...
        function render_thumb_article($post, $user, $override = array()) {
            ...
            if ($override["tpl"] == 0) $override["tpl"] = $this->o["default_tab_template"];
